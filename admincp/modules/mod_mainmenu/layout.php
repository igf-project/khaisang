			...
			<li class="dropdown dropdown-user">
				...
				<ul class="dropdown-menu dropdown-menu-default">
                    ...
                    if($UserLogin->isAdmin()==true){?>
                        ...
                        <li>
                            <a href="index.php?com=users&task=send_mail">
                                <i class="fa fa-envelope-o" aria-hidden="true"></i> Gửi tin tới khách hàng</a>
                        </li>
                        <li>
                            <a href="index.php?com=mnuitem&mnuid=10">
                                <i class="fa fa-bars" aria-hidden="true"></i> Cấu hình menu</a>
                        </li>
                        ...
                        <li>
                            <a href="index.php?com=slider_recruitment">
                                <i class="fa fa-sliders" aria-hidden="true"></i> Cấu hình slider tuyển dụng</a>
                        </li>
                        <li>
                            <a href="index.php?com=sale">
                                <i class="fa fa-sliders" aria-hidden="true"></i> Cấu hình khuyến mại</a>
                        </li>
                    <?php } ?>
