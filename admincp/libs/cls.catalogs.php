...
class CLS_CATALOGS{
    ...
    public function listTable($strwhere="",$page){
        ...
        {	$i++;
            ...
            $category=$this->getGroupById($rows['group_id']);
            echo "<tr name=\"trow\">";
	...
	public function Add_new(){
		$sql=" INSERT INTO `tbl_catalog`(`name`,`group_id`,`catagroup_id`,`code`,`isactive`) VALUES";
		$sql.="('".$this->Name."','".$this->GroupID."','".$this->CataGroupID."','".$this->Code."','".$this->isActive."')";
		return $this->objmysql->Exec($sql);
	}
	public function Update(){
		$sql = "UPDATE tbl_catalog SET `name`='".$this->Name."',`group_id`='".$this->GroupID."',`catagroup_id`='".$this->CataGroupID."',`code`='".$this->Code."',`isactive`='".$this->pro["isActive"]."' WHERE id='".$this->ID."'";
		return $this->objmysql->Exec($sql);
	}
